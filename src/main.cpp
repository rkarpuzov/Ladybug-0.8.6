...
uint256 hashGenesisBlock("0x0000000066247638c1b022cb6f224c2600e6ad8d3d1bb48e869bb7a153f3be1d");
...
const string strMessageMagic = "Ladybug Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000fcbb9ed933c2ad19a410f4d740bc95f7454dc3844eac97e7656c283c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1448621995;
        block.nBits    = 486604799;
        block.nNonce   = 2826399945;
...
//        assert(hashGenesisBlock == uint256("0x00000000fcbb9ed933c2ad19a410f4d740bc95f7454dc3844eac97e7656c283c"));
        assert(block.hashMerkleRoot == uint256("0x15f722118330cdc1d1f2c5446e052605cd8c18e2b42eba1de1b884bc28a8bfed"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LadybugMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LadybugMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running LadybugMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("LadybugMiner terminated\n");
        throw;
    }
}
